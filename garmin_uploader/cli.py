...
def main():
    ...
    parser.add_argument("-u", "--username", dest="username", type=str, help="Garmin Connect user login")
    parser.add_argument("-p", "--password", dest="password", type=str, help="Garmin Connect user password")
    parser.add_argument(
        "-v",
        "--verbose",
        dest="verbose",
        ...
        " 2=INFO, 3=WARNING, 4=ERROR, 5=CRITICAL (least verbose).  [default=2]",
    )
